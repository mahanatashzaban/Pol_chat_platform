...
var PasswordUtils = /** @class */ (function () {
    ...
    PasswordUtils.hashPassword = function (password) {
    ...
    PasswordUtils.comparePassword = function (password, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PasswordUtils.isPasswordStrong = function (password) {
